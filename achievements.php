...
class Achievements{
  ...
  function displayData($dbhost,$dbuser,$dbpass){
...
//fetch all data from the table
    $sql = 'SELECT achievements,ach_id FROM achievements WHERE studentID="170007T"';
...
$ach_class->displayData($dbhost,$dbuser,$dbpass);
